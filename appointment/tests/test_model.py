...
class PersonTestCase(TestCase):
    ...
    def test_validate_attributes(self):
        self.assertTrue(name_validator(self.validated_person.name))
        self.assertTrue(cpf_validator(self.validated_person.cpf))
        self.assertTrue(phone_validator(self.validated_person.phone_number))
